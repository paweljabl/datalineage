...
# python manage.py makemigrations datalin --empty
...
def insert_technolofy(apps, schema_editor):
    ...
    technology.save()
    technology = Technology(short_name='QV', name='QlikView', provider='Qlik')
    technology.save()
    technology = Technology(short_name='QS', name='Qlik Sense', provider='Qlik')
    technology.save()
    technology = Technology(short_name='Lumira', name='Lumira', provider='SAP')
    technology.save()
    technology = Technology(short_name='Power BI', name='Power BI', provider='Microsoft')
    technology.save()
...
def insert_entity(apps, schema_editor):
    ...
    t.entity_set.create(short_name='SP', name='Stored Procedure', is_storage='Y', is_presentation='N')
    t.save()
    entity = Entity(short_name='App', name='Application', description='An application from yellow pages, like source or BI application', is_storage='N', is_presentation='N', is_application='Y')
    entity.save()
